...
window.addEventListener('DOMContentLoaded', () => {
  ...
  class MenuCard {
    constructor(src, alt, title, descr, price, parentSelector, ...classes) {
      ...
      this.transfer = 36.17; // курс доллара
    ...
    render() {
      ...
      element.innerHTML = `
                    ...
                    <div class="menu__item-price">
                        ...
                        <div class="menu__item-total"><span>${this.price.toFixed(2)}</span> грн</div>
                    </div>
                `;
  ...
  new MenuCard("img/tabs/daVinci.jpg", "DaVinci panel", 'Панель "DaVinci Micro"', 'Панель "DaVinci Micro" - Которую я продаю на OLX', 800, '.menu .container', 'menu__item').render();
});
